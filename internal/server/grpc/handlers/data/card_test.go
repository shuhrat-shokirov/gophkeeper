...
func Test_handler_SaveCard(t *testing.T) {
	t.Run("err from service", func(t *testing.T) {
		...
		service.On("SaveCard", t.Context(), mock.Anything).Return(assert.AnError)

		resp, err := h.SaveCard(t.Context(), &pb.CardData{
			Meta: &pb.BaseData{},
		})
	...
	t.Run("success", func(t *testing.T) {
		...
		service.On("SaveCard", t.Context(), mock.Anything).Return(nil)
