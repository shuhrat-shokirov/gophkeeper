...
func Test_handler_SaveBinary(t *testing.T) {
	t.Run("err from service", func(t *testing.T) {
		...
		service.On("SaveBinary", t.Context(), mock.Anything).Return(assert.AnError)

		resp, err := h.SaveBinary(t.Context(), &pb.BinaryData{
			Meta: &pb.BaseData{},
		})
	...
	t.Run("success", func(t *testing.T) {
		...
		service.On("SaveBinary", t.Context(), mock.Anything).Return(nil)
